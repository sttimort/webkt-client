...
goog.exportSymbol('proto.Metadata.Type', null, global);
/**
...
proto.Metadata.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = /** @type {!proto.Metadata.Type} */ (reader.readEnum());
      msg.setType(value);
      break;
    default:
      reader.skipField();
 ...
 * @return {!proto.Metadata.Type}
 */
proto.Metadata.prototype.getType = function() {
  return /** @type {!proto.Metadata.Type} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};


/**
 * @param {!proto.Metadata.Type} value
 * @return {!proto.Metadata} returns this
 */
proto.Metadata.prototype.setType = function(value) {
